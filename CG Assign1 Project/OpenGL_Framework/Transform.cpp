...
void Transform::update(float dt)
{
	...
	mat4 rx; rx.RotateX(m_pLocalRotationEuler.x);
	mat4 ry; ry.RotateY(m_pLocalRotationEuler.y);
	mat4 rz; rz.RotateZ(m_pLocalRotationEuler.z);
